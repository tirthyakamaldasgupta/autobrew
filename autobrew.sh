...
main() {
    ...
    tap_list=""
    term_list=""
    cask_list="google-chrome docker free-download-manager firefox jetbrains-toolbox logitech-camera-settings logi-options+ lunar opera raycast vagrant vagrant-vmware-utility vlc vmware-fusion visual-studio-code"
    clear
    term_colors
    script_info
    check_continue
